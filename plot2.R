...
# Plot #2
#
# Timeseries plot of daily consumption
#
# 
...
# Step 4 - building the plot2

plot(filtered_data$DateTime, filtered_data$Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab="")

# copy chart to png
dev.copy(png, file="plot2.png",  bg="white")
dev.off()
